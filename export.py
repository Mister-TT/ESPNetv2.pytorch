...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', default='/home/aistudio/ESPNetv2.pytorch/imagenet/', help='path to dataset')
    ...
    parser.add_argument('--batch-size', default=256, type=int, help='mini-batch size (default: 512)')
